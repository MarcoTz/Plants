...
CREATE TABLE activities (name string unique, date string, plant string not null, note string);
CREATE TABLE graveyard (name string unique, species string, planted string, died string, reason string);
CREATE TABLE growth (plant string unique, date string, height_cm real ,width_cm real, note string, health int);
