...
def create_plant():
    ...
    plant_name   : str       = input('Enter Plant name: ')
    species_name : str       = input('Enter plant species: ')
    height       : float     = float(input('Enter current height (in cm):'))
    width        : float     = float(input('Enter current width (in cm):'))
    location     : str       = input('Enter current location: ')
    origin       : str       = input('Enter plant origin: ')
    obtained     : str       = input('Enter obtained date (dd.mm.yyyy)')
